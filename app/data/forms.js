      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: "t1_s3_q6",
            num: "3.3",
            label: "The Price Signal",
            directive:
              "Where are you priced now, and where do you intend to sit after this brand is deployed? Be specific with numbers. The visual and verbal identity is engineered to support your target price point — this shapes the build.",
            type: "textarea",
            rows: 3,
            placeholder: "Currently mid-market at R8K/project.",
          },
          {
            id: "t1_s3_q6_b",
            num: "",
            type: "textarea",
            rows: 3,
            placeholder: "Post-brand target: R25K+ premium positioning.",
          },
        ],
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            directive:
              "What colours, typeface styles, aesthetics, symbols or design languages must NEVER appear in your brand? Be specific. 'Nothing too corporate' is not a brief. 'No serif fonts, no blue and no stock imagery' is a brief.",
            type: "textarea",
            rows: 3,
