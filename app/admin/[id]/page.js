...
export default function SubmissionDetail() {
  ...
  function renderAnswer(q, formData) {
          ...
          {ASSET_SLOTS.map(slot => {
            ...
            return (
              <div key={slot} style={{ display: 'contents' }}>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--muted)', letterSpacing: '0.1em', padding: '6px 0' }}>
                  {slot}
                </div>
                <div style={{ fontSize: '13px', color: 'var(--body)', padding: '6px 0', borderBottom: '1px solid var(--border)' }}>
                  {val}
                </div>
              </div>
            )
          ...
          {q.scales.map((s, si) => {
            ...
            return (
              <div key={si} style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--muted)', minWidth: '140px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                  {s.left}
                </span>
                ...
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                  {s.right}
                </span>
              </div>
            )
            ...
            return (
              <div key={ii} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: '1px solid var(--border)' }}>
                ...
                <span style={{
                  ...
                  color: val === 'yes' ? '#2ecc71' : val === 'no' ? 'var(--red)' : 'var(--muted)',
    ...
    return (
      <div style={{
        fontSize: '14px', color: 'var(--body)', lineHeight: '1.7',
        padding: '16px 18px',
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--muted)', letterSpacing: '0.15em', textTransform: 'uppercase', marginRight: '8px' }}>
            Status:
          </span>
            ...
            return (
              <button
                ...
                style={{
                  fontFamily: 'var(--font-mono)', fontSize: '10px',
                  letterSpacing: '0.2em', textTransform: 'uppercase',
                  padding: '6px 14px', cursor: isActive ? 'default' : 'pointer',
      ...
      <div style={{ width: '100%', maxWidth: '860px', marginBottom: '48px' }}>
        ...
        <div className="section-title" style={{ fontSize: 'clamp(36px, 5vw, 56px)', marginBottom: '16px' }}>
          BRIEF<br />SUBMISSION
        </div>
          ...
          <div key={si} style={{ marginBottom: '64px' }}>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <div
                ...
                style={{ fontSize: 'clamp(28px, 4vw, 44px)', marginBottom: '8px' }}
            ...
            {sec.questions.map(q => (
              <div key={q.id} style={{ marginBottom: '40px' }}>
                {q.label && (
                  <div className="q-label" style={{ marginBottom: '12px' }}>
      ...
      {/* Bottom back button */}
      <div style={{ width: '100%', maxWidth: '860px', paddingBottom: '80px', paddingTop: '40px', borderTop: '1px solid var(--border)' }}>
        <button className="btn-nav" onClick={() => router.push('/admin')}>
